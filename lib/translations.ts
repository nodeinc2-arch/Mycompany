...
export const translations = {
  en: {
    ...
    finance: {
      ...
      privacyTitle: 'Private by design — your data never leaves your walls',
      privacyNote: 'No client is comfortable sending payroll and financial details to the cloud — so we don\'t. Our AI auditing runs entirely on your own infrastructure. Sensitive data stays in your environment, never sent to any third-party cloud AI.',
      features: [
  ...
  fr: {
    ...
    finance: {
      tagline: 'Finance et paie · IA native',
      title: 'Une couche d\'audit IA native pour la paie.',
      complianceWord: 'couche d\'audit IA native pour la paie.',
      description: 'Notre outil financier à IA native connecte les sociétés de paie et ajoute une couche d\'audit intelligente à travers leurs systèmes — avec une IA exécutée localement pour une confidentialité totale et la conformité canadienne.',
      subtitle: 'Dirigée par une spécialiste de la paie, notre équipe offre aussi du conseil concret en paie — de l\'implémentation de Workday à la conformité — pour que vos chiffres soient toujours exacts et prêts pour l\'audit.',
      privacyTitle: 'Confidentiel par conception — vos données ne quittent jamais vos murs',
      privacyNote: 'Aucun client n\'est à l\'aise d\'envoyer ses détails de paie et financiers dans le cloud — alors nous ne le faisons pas. Notre audit IA s\'exécute entièrement sur votre propre infrastructure. Les données sensibles restent dans votre environnement, jamais envoyées à une IA cloud tierce.',
      features: [
